    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#F5F2EB' }}>
      ...
      <main style={{ flex: 1, maxWidth: 720, width: '100%', margin: '0 auto', padding: '80px 24px 120px' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1] }}>
          ...
          <p style={{ fontSize: 15, color: 'var(--concrete)', lineHeight: 1.85, maxWidth: 460, marginBottom: 56, fontWeight: 300 }}>Brand as a person. Click either side of a tension to explore alternatives with different nuance.</p>
        </motion.div>
